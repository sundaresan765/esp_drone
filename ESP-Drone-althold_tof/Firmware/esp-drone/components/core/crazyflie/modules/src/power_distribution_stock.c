...
void ispowerDistributionInit(void)
{
//  printf("it was inside in ispowerdistrubtioninit\n");

//  ismotorsInit(platformConfigGetMotorMapping());
 bool pass = true;
  
  pass &=smotorsTest();
  printf("testing in power distribution\n");
  return pass;
